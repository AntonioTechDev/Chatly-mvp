...
import { searchContactsForLinking, linkContacts } from '@/core/services/contactService'
import './LinkContactModal.css'
...
export const LinkContactModal: React.FC<LinkContactModalProps> = ({
  ...
  return (
    <div className="link-contact-modal-overlay" onClick={onClose}>
      <div className="link-contact-modal" onClick={(e) => e.stopPropagation()}>
        <div className="modal-header">
          <h3>Collega Contatto</h3>
        ...
        <div className="modal-content">
          <div className="search-section">
            <label>Cerca contatto da collegare</label>
            ...
            <p className="search-hint">Digita almeno 2 caratteri per cercare</p>
          </div>
        ...
        <div className="modal-footer">
          ...
          <button onClick={handleLink} disabled={!selectedContactId} className="link-button">
            Collega Contatto
          </button>
        </div>
      </div>
